		...
		<>
			<MembersSection>
				<DevelopersCard
					...
					linkedin={'https://www.linkedin.com/in/solomon-santhosh-i-4854a3212/'}
					color={'#ff9933'}
				/>
				<DevelopersCard
					...
					linkedin={'https://www.linkedin.com/in/aravindh-r-9834a6202/'}
					color={'#fc74fd'}
				/>
				<DevelopersCard
					name={'Lohith R'}
					description={'Full Stack'}
					instagram={'https://www.instagram.com/_lohith_s.r.k_/?hl=en'}
				...
				<DevelopersCard
					...
					linkedin={'https://www.linkedin.com/in/prasanna-rv-a3233a1ba/'}
					color={'#fe4164'}
				/>
			</MembersSection>
		</>
