...
export const TalentFest = {
	...
	description:
		'The contestants should showcase their talent within the given time limit. Both solo and group performances are allowed. All types of talents are welcomed to perform._*A registration fee of Rs.50 (Per head) will be collected on the day of the event to participate in as many non - technical events of your choice.',
	rules: [
		'Only one entry per participant is permitted.',
...
export const SquidGame = {
	...
	description:
		'Not so fast. Wait until the day of the event to find out._*A registration fee of Rs.50 (Per head) will be collected on the day of the event to participate in as many non - technical events of your choice.',
	rules: [
		'Only one entry per participant is permitted.',
...
export const BoxCricket = {
	...
	description:
		'The is a gully cricket tournament event. Further details of the event will be dealt on the day of the event._*A registration fee of Rs.50 (Per head) will be collected on the day of the event to participate in as many non - technical events of your choice.',
	rules: [
		'Only one entry per participant is permitted.',
		'Rules will be explained in detail on the day of the event.'
	],
...
export const Advertisement = {
	...
	timestamp: '10 am to 12.30 pm',
	description:
		'The contestant will be provided with the name of a product and 2 minutes of time for preparation. The contestant should come up with a convincing act to sell out their product._*A registration fee of Rs.50 (Per head) will be collected on the day of the event to participate in as many non - technical events of your choice.',
	rules: [
		'Only one entry per participant is permitted.',
