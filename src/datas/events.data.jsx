...
export const SquidGame = {
    ...
    description:
        "Not so fast. Wait until the day of the event to find out._*A common registration fee of Rs.100 (Per head) will be collected on the day of the event to participate in as many technical and non - technical events of your choice.",
    rules: [
        "Only one entry per participant is permitted.",
